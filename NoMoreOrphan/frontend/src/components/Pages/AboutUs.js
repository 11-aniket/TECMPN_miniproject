...
const AboutUs = () => {
  return (
    <>
    <MyNavbar/>
    <div className='w-screen mt-4 mx-2 justify-center items-center'>
        <p className=''>
        <img className=' w-screen pt-10 h-[40rem]' src="./images/aboutus.png" alt="" />
        <div className='absolute left-20 top-1/3 right-20 text-white mr-10 text-justify text-6xl font-bold space-y-2'>
        <h1>Who Are We</h1>
