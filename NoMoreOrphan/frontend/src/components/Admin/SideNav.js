...
function Side_nav  () {
  let Links = [
    ...
    {name:"Child Gallery",link:"/childgallery"},
  ...
  return (
    ...
    <sidenav className={`md:flex md:items-center md:space-x-5 md:py-0 pb-8 md:px-0 px-5 flex m-4 py-6 absolute md:static md:z-auto z-[4] md:mt-16 md:w-2/5 left-0 top-0 md:my-0 my-14 md:mx-0 mx-1 w-fit transition-all duration-500 ease-in rounded-2xl ${ open ? 'top-0' : '-top-[1000px]'}`}>
        <div className='flex flex-col cursor-pointer sm:text-white sm:bg-slate-600 md:bg-white md:text-black font-semibold md:w-2/5 sm:w-1/2 mx-4 space-y-3 py-5'>
            {/* <h2 className='hover:border-solid hover:border-2 hover:border-gray-500 md:m-2 text-xl md:px-2'>Home</h2>
            <h2 className='hover:border-solid hover:border-2 hover:border-gray-500 md:m-2 text-xl md:px-2'>Child Gallery</h2>
            <h2 className='hover:border-solid hover:border-2 hover:border-gray-500 md:m-2 text-xl md:px-2'>Missions</h2>
            <h2 className='hover:border-solid hover:border-2 hover:border-gray-500 md:m-2 text-xl md:px-2'>Photo Gallery</h2>
            <h2 className='hover:border-solid hover:border-2 hover:border-gray-500 md:m-2 text-xl md:px-2'>News Letter</h2>
            <h2 className='hover:border-solid hover:border-2 hover:border-gray-500 md:m-2 text-xl md:px-2'>Feedback</h2>
            <h2 className='hover:border-solid hover:border-2 hover:border-gray-500 md:m-2 text-xl md:px-2'>Contact Us</h2>
            <h2 className='hover:border-solid hover:border-2 hover:border-gray-500 md:m-2 text-xl md:px-2'>Donation</h2>
            <h2 className='hover:border-solid hover:border-2 hover:border-gray-500 md:m-2 text-xl md:px-2'>Doctors</h2>
            <h2 className='hover:border-solid hover:border-2 hover:border-gray-500 md:m-2 text-xl md:px-2'>Parents</h2> */}
