...
const SignUp = () => {
  ...
  return (
    <>
       <div className="relative w-full h-screen justify-center  bg-gray-900/80 p-10 md:p-0">
            ...
            <div className='flex justify-center items-center h-full rounded-2xl'>
                <form action="" className='max-w-[800px] w-full mx-auto bg-slate-50 p-8 rounded-2xl'>
                    <h2 className='text-4xl font-bold text-center py-4 border-x-8 rounded-2xl bg-cyan-900 opacity-80'>Orphan Foundation Center</h2>
                    <hr/>
